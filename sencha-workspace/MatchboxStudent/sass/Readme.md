...
folder are mapped to the application's root namespace, 'MatchbookStudent'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "MatchbookStudent"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'MatchbookStudent' in the same way
as `"MatchbookStudent/sass/src"`.
