            ...
            <div class="col-inner">
                ...
                {if $.User->hasAccountLevel(Staff)}
                    ...
                    <ul class="course-section-tools plain">
                        <li><a class="button" href="/spark/classroom/teacher#{$Section->Code}:gps">Launch Spark</a></li>
                ...
                {elseif $Section->getParticipant($.User)}
                    <h3 class="well-title">Course Tools</h3>
                    <ul class="course-section-tools plain">
                        <li><a class="button" href="/spark/classroom/student#{$Section->Code}::">Launch Spark</a></li>
                    </ul>
                {/if}
