...
folder are mapped to the application's root namespace, 'SparkClassroomTeacher'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SparkClassroomTeacher"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SparkClassroomTeacher' in the same way
as `"SparkClassroomTeacher/sass/src"`.
