...
var util = require('../../lib/util'),
    Values = util.Values,
    entities = ['learn', 'apply', 'assess', 'conference'],
...
function *getHandler() {
    var vals = new Values(),
        ...
        // HACK: Since all preference tables have the same structure, we use learn_preferences here:
        where = util.whereFromRequest.call(this, 'learn_preferences', vals);

    entities.forEach(function(entity) {
        let tableName = `${pluralize.singular(entity)}_preferences`;
...
function *patchHandler() {
    ...
    for (var entity in body) {
        ...
        if (entities.indexOf(entity) === -1) {
            ...
            errors.push(`${key} must be an array of ${pluralize.singular(entity)} preference objects`);
        } else {
