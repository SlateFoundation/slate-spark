        ...
        tpl: [
            ...
            '<ol class="spark-worklist">',
                '<tpl if="values.items.length &gt; 0">',
                    '<tpl for="items">',
                        '<li class="spark-worklist-item <tpl if="(values.assignment.section || values.assignment.student)">is-required</tpl> <tpl if="values.source == \'student\'">is-student-submitted</tpl>">',
