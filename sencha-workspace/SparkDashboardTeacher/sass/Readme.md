...
folder are mapped to the application's root namespace, 'SparkDashboardTeacher'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SparkDashboardTeacher"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SparkDashboardTeacher' in the same way
as `"SparkDashboardTeacher/sass/src"`.
