...
function* getHandler() {
    ...
    result = yield Promise.props({
        fuseboxQuestions: this.pgp.manyOrNone('SELECT * FROM slate1.s2_guiding_questions WHERE standardids::JSONB ?| $1', [standardIds]),
        ...
        resources: this.pgp.manyOrNone('SELECT * FROM slate1.s2_conference_resources WHERE standardids::JSONB ?| $1', [standardIds]),
