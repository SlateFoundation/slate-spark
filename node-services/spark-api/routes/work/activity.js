    ...
    var sectionId = this.query.section_id,
        query = `
            SELECT t.last_accessed,
                   ...
                   t.student_id,
                   t.sparkpoint_id,
                   learn_start_time, learn_finish_time, conference_start_time, conference_finish_time, conference_join_time, apply_start_time, apply_ready_time, apply_finish_time, assess_start_time, assess_ready_time, assess_finish_time, conference_group_id, selected_apply_id, selected_fb_apply_id,
                   code AS sparkpoint
              FROM (
                SELECT student_id,
                       sparkpoint_id,
