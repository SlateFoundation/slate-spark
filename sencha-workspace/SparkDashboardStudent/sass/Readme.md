...
folder are mapped to the application's root namespace, 'SparkDashboardStudent'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SparkDashboardStudent"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SparkDashboardStudent' in the same way
as `"SparkDashboardStudent/sass/src"`.
